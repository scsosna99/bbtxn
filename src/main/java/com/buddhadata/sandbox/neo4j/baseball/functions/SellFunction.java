 ...
 */
public class SellFunction extends BaseFunction {
     ...
     * Singleton instance
     */
    public static BaseFunction INSTANCE = new SellFunction(regex);


    /**
     * Private constructor to prevent instantiation.
     */
    private SellFunction(String regex) {
        super (regex);
    };
    ...
    public List<TxnBase> apply (Element element,
        ...
        if (children.size() == 7) {
            ...
            Team sellingTeam = findOrCreateTeam((Element) children.get(SELL_TEAM_NODE_INDEX), session);
            toReturn = new SellTxn(sellingTeam, player, null);
        } else {
