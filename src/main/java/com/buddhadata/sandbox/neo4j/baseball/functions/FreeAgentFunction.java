...
import com.buddhadata.sandbox.neo4j.baseball.relationship.FreeAgentTxn;
 ...
 */
public class FreeAgentFunction extends BaseFunction {
     ...
     * Singleton instance
     */
    public static BaseFunction INSTANCE = new FreeAgentFunction(regex);


    /**
     * Private constructor to prevent instantiation.
     */
    private FreeAgentFunction(String regex) {
        super (regex);
    };
