...
abstract public class TransactionProcessor {
    ...
    /**
     * The method implemented by specific transaction processor
     * @param session
     * @param transactionType
     * @param fields
     * @param unassigned
     */
    abstract public void process (Session session, TransactionType transactionType, String[] fields, Unassigned unassigned);
    ...
    public static Constructor getConstructor (Class clazz,
        ...
        try {
            return clazz.getConstructor(constructorArgs);
